function [projected, valid, dist, depth] = projectPoints( points, K, T, D, imageSize, sortPoints )
...
depth = nan(size(valid,1), 1);
depth(valid) = tmp_depth_recorder;
